...
class ActorRolloutRefWorker(MegatronWorker, DistProfilerExtension):
    ...
    def save_checkpoint(self, checkpoint_path, hdfs_path=None, global_step=0, max_ckpt_to_keep=None):
        ...
        # Skip barrier when async_save is enabled — synchronization happens in async_calls_finalize_fn_exec
        if not self.checkpoint_mananager.checkpoint_config.async_save:
