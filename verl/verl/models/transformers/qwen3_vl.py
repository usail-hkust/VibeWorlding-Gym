...
def _get_input_embeds(
    ...
    if pixel_values is None and pixel_values_videos is None:
        ...
        # Fix: assign deepstack_visual_embeds so it's not None when returned,
        # otherwise mbridge's split_deepstack_embs will raise TypeError iterating None.
        deepstack_visual_embeds = dummy_deepstack_image_embeds if dummy_deepstack_image_embeds else []
